defmodule S3Uploader do
  ...
  defp config do
    %{
      region: region(),
      access_key_id: Application.fetch_env!(:built_with_phoenix, :access_key_id),
      secret_access_key: Application.fetch_env!(:built_with_phoenix, :secret_access_key)
    }
  end
  ...
  def bucket do
    Application.fetch_env!(:built_with_phoenix, :bucket)
  end

  def region do
    Application.fetch_env!(:built_with_phoenix, :region)
  end
